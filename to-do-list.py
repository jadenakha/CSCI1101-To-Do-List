...
while True:
    ...
    # likely to be its own function
    # this doesnt have to be in loop
    def taskchecking():
        checkstatus = int(input("Would you like to check / uncheck something? Type 'exit' to return back to options: "))
        if checkstatus == "exit":
